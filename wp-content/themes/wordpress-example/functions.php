...
add_action('init', 'resources_type_init');
	function resources_type_init()
	{
	$labels = array(
	'name' => '资源中心',
	'singular_name' => '资源中心',
	...
	'search_items' => '搜索资源中心',
	'not_found' =>  '未添加资源中心',
	'not_found_in_trash' => '回收站中未找到资源中心',
	'parent_item_colon' => '',
	'menu_name' => '资源中心'
	...
	'taxonomies' => array(  'post_tag', 'portfolio' ),
	'has_archive' => true,
	'hierarchical' => false,
	'menu_position' => 5,
	'supports' => array('title','editor','author','thumbnail','excerpt','comments')
...
function create_product_taxonomies() {
    register_taxonomy(
        'resources_genre',  //自定义分类法的名称
        'resources',    //分类对应的文章类型
        array(
            'labels' => array(
                'name' => '资源中心分类',
                'add_new_item' => '新增资源中心分类',
                'new_item_name' => "新增资源中心分类名称"
            ),
            'show_ui' => true,
            'show_tagcloud' => false,
            'hierarchical' => true
